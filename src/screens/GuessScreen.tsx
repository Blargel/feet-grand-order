import { HeelPortrait, PageWrapper, ServantAutocomplete, ServantAutocompleteOption } from '@/components'
  ...
  return (
    <PageWrapper>
...

      {
        ...
        <div className='mt-4'>
          <Typography color="error" variant="body2" display="inline">Sorry, the guess</Typography>
          <Typography color="error" variant="subtitle2" display="inline">{" " + mostRecentGuess + " "}</Typography>
          <Typography color="error" variant="body2" display="inline">is incorrect!</Typography>
        </div>
      }
